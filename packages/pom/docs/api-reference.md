...
| `AUTOFIT_OVERFLOW`            | Content still exceeds the slide height after all autoFit adjustments. When available, the message identifies the furthest direct child and reports its `y`, height, and bottom edge.                                                                                                                                        |
