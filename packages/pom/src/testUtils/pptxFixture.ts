...
/**
 * Build a synthetic PPTX package (as a zip byte buffer) with the given slide
 * masters, each carrying its own layouts and theme color scheme. Used to
 * exercise slideMaster/layout enumeration without a binary fixture file.
 */
